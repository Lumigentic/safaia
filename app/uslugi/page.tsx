          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {[
                ...
                <div
                  key={index}
                  className="text-center p-8 bg-[var(--cream)] rounded-lg hover:shadow-xl transition-all duration-300 hover:scale-105 stagger-item"
            ...
            <div className="bg-white p-10 rounded-lg shadow-sm">
              <div className="grid md:grid-cols-2 gap-10 items-start">
                <div>
                  ...
                  <p className="text-[var(--color-text-muted)] font-body leading-relaxed mb-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-lg font-heading text-[var(--sapphire-deep)] mb-2">
      ...
      <section className="section-padding bg-white">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-xl text-[var(--color-text-muted)] font-body mb-12 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Pakiet Basic */}
              <div className="border-2 border-[var(--lavender-soft)] rounded-lg p-8 hover:border-[var(--sapphire-deep)] transition-all duration-300 hover:shadow-xl">
                <h3 className="text-2xl mb-4 text-[var(--sapphire-deep)] font-heading">
                  Basic
                </h3>
                <p className="text-[var(--color-text-muted)] font-body mb-6">
                  Dla autorów, którzy potrzebują wsparcia redakcyjnego
                </p>
                <ul className="space-y-3 mb-8 text-sm text-[var(--color-text-muted)] font-body">
                  <li className="flex items-start">
                    <span className="text-[var(--sapphire-deep)] mr-2">✓</span>
                    Redakcja stylistyczna
                  </li>
                  <li className="flex items-start">
                    <span className="text-[var(--sapphire-deep)] mr-2">✓</span>
                ...
                <Link
                  href="/kontakt"
                  className="block text-center px-6 py-3 border-2 border-[var(--sapphire-deep)] text-[var(--sapphire-deep)] font-body tracking-wide rounded-sm hover:bg-[var(--sapphire-deep)] hover:text-white transition-all duration-300"
                >
                  Zapytaj o cenę
                </Link>
              </div>
              ...
              {/* Pakiet Premium */}
              <div className="border-2 border-[var(--sapphire-deep)] rounded-lg p-8 bg-gradient-to-br from-[var(--sapphire-deep)]/5 to-transparent relative hover:shadow-2xl transition-all duration-300 scale-105">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-[var(--gold-accent)] text-white px-4 py-1 rounded-full text-sm font-body">
                  Najpopularniejszy
                </div>
                <h3 className="text-2xl mb-4 text-[var(--sapphire-deep)] font-heading">
                  Premium
                ...
                <Link
                  href="/kontakt"
                  className="block text-center px-6 py-3 bg-[var(--sapphire-deep)] text-white font-body tracking-wide rounded-sm hover:bg-[var(--indigo-dark)] transition-all duration-300 hover:shadow-lg"
                >
                  Zapytaj o cenę
                </Link>
              </div>
